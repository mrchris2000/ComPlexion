...
namespace Complexion.Portable
{
    internal class ObservableCollectionEx<T>: ObservableCollection<T>
    {
        ...
        internal bool UpdateToMatch<TKey>(ICollection<T> collection, Func<T, TKey> keyFunc, Func<T, T, bool> updateAction = null)
        {
            var updated = false;
        ...
        internal bool UpdateToMatch<TKey>(T item, Func<T, TKey> keyFunc, Func<T, T, bool> updateAction = null)
        {
